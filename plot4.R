...
#setup plot area to be 2X2
par(mfrow = c(2,2))

#create Global Active Power plot
plot(powerDataFeb0102$CombDateTimeNew, powerDataFeb0102$Global_active_power, type = "l", xlab='',  ylab="Global Active Power")

#create Voltage Plot
plot(powerDataFeb0102$CombDateTimeNew, powerDataFeb0102$Voltage, type = "l", xlab='datetime',  ylab="Voltage")
...
plot(powerDataFeb0102$CombDateTimeNew, powerDataFeb0102$Global_reactive_power, type = "l", xlab='datetime',  ylab="Global_reactive_power")
